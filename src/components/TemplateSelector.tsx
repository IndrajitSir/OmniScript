  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-1.5 rounded-lg border border-[var(--os-border)] bg-[var(--os-bg)]/40 p-2">
        ...
        <ul className="os-scroll -mr-1 flex max-h-[35rem] min-h-0 flex-1 flex-col gap-1 overflow-y-auto pr-1 gap-1.5 rounded-lg border border-[var(--os-border)] bg-[var(--os-bg)]/40 p-2">
